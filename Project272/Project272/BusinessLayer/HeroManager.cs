...
namespace Project272.BusinessLayer
{
    public class HeroManager
    {
        ...
        public void AddHero(SuperHero hero, List<SuperHero> currentHeroes)
        {
        ...
        public void UpdateHeroes(List<SuperHero> heroes)
        {
        ...
        public void DeleteHero(SuperHero superHero, List<SuperHero> heroes)
        {
